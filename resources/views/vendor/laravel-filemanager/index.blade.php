            ...
            <div class="form-group" id="attachment" style="text-align: right; direction: rtl">
              ...
              <div class="controls">
                <div class="input-group" style="width: 100%; direction: ltr">
                  <input type="file" id="upload" name="upload[]" multiple="multiple"  data-buttonText="انتخاب تصویر" data-buttonBefore="true" data-buttonName="btn-primary" class="form-control filestyle">
                </div>
              </div>
            </div>
